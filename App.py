...
if missing_columns:
    ...
    if st.session_state.location:
        ...
        st.markdown(f"""
            <div style='width: 80%; font-size: 1.3em; text-align: justify; padding: 10px; border: none;'>
...
for texture, description in soil_classes.items():
    st.markdown(f"<div style='width: 80%; font-size: 1.3em; text-align: justify; padding: 10px; border: none;'>{texture}: {description}</div>", unsafe_allow_html=True)
...
# Footer
st.markdown(f"""  
    <div style='width: 80%;text-align: center; font-size: 1.3em; text-align: justify; padding: 10px; border: none;'>  
    ---
...
st.markdown(f"""  
<div style='width: 80%; font-size: 1.3em; text-align: justify; padding: 10px; border: none;'>DISCLAIMER NOTE: 
